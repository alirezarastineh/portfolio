              ...
              <div className="w-screen flex-shrink-0 snap-center flex flex-col space-y-7 items-center justify-center p-20 md:p-44 h-screen scroll-smooth">
                ...
                <div className="space-y-10 px-0 md:px-10 max-w-6xl cursor-pointer">
                  ...
                  <p className="text-lg text-center md:text-left">
                    A Website for checking top 10 Cryptocurrency coins, with
                    their real live stats. Included authorization with the
                    option for users to choose coins for their watchlist.
                  </p>
                </div>
              </div>
            </motion.div>
